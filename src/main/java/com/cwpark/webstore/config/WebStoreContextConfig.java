package com.cwpark.webstore.config;
...
import com.cwpark.webstore.interceptor.PromoCodeInterceptor;
import com.cwpark.webstore.validator.ProductImageValidator;
import com.cwpark.webstore.validator.UnitsInStockValidator;

import binder.ProductValidator;

@Configuration
@EnableWebMvc
@ComponentScan("com.cwpark.webstore")
